...
public class newproductAdapter extends RecyclerView.Adapter<newproductAdapter.DataHolders> {
    private List<product> productsmodel;
    private OnClickproduct onClickproduct;

    public newproductAdapter(OnClickproduct onClickproduct) {
    ...
    public void onBindViewHolder(@NonNull @NotNull DataHolders holder, int position) {
        ...
        //  System.out.println("cjkdnvccccc + "+Uri.parse(productsmodel.get(position).getImageproduct()));
